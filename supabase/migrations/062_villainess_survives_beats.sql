-- Migration: 062_villainess_survives_beats.sql
-- ADR-009: Beat Contract System - Villainess Survives Series Update
--
-- Updates all 6 episodes of the Villainess Survives series with:
...
SET
    ...
    on_success = '{"set_flag": "duke_intrigued", "suggest_episode": "the-masquerade"}'::jsonb,
    on_failure = '{"set_flag": "duke_unmoved"}'::jsonb,
    turn_budget = 8,
    beats = '[
        {
...
SET
    ...
    failure_condition = 'turn_budget_exceeded',
    on_success = '{"set_flag": "survived_masquerade", "suggest_episode": "the-garden-gambit"}'::jsonb,
    on_failure = '{"set_flag": "masquerade_disaster"}'::jsonb,
    turn_budget = 10,
    beats = '[
        {
            "id": "dance_command",
...
SET
    ...
    failure_condition = 'turn_budget_exceeded',
    on_success = '{"set_flag": "truth_partially_accepted", "suggest_episode": "the-original-sin"}'::jsonb,
    on_failure = '{"set_flag": "truth_rejected"}'::jsonb,
    turn_budget = 10,
    beats = '[
        {
            "id": "cornered",
...
SET
    ...
    failure_condition = 'turn_budget_exceeded',
    on_success = '{"set_flag": "knows_full_truth", "suggest_episode": "the-trial"}'::jsonb,
    on_failure = '{"set_flag": "truth_incomplete"}'::jsonb,
    turn_budget = 12,
    beats = '[
        {
...
SET
    ...
    failure_condition = 'turn_budget_exceeded',
    on_success = '{"set_flag": "survived_trial", "suggest_episode": "the-rewrite"}'::jsonb,
    on_failure = '{"set_flag": "trial_condemned"}'::jsonb,
    turn_budget = 12,
    beats = '[
        {
            "id": "trial_begins",
...
SET
    ...
    failure_condition = 'turn_budget_exceeded',
    on_success = '{"set_flag": "choice_made"}'::jsonb,
    on_failure = '{"set_flag": "choice_deferred"}'::jsonb,
    turn_budget = 10,
    beats = '[
        {
            "id": "quiet_moment",
    ...
    updated_at = NOW()
WHERE slug = 'the-rewrite';


-- Log completion
DO $$
BEGIN
    RAISE NOTICE 'Villainess Survives series updated with ADR-009 beats';
END $$;
