"""
Research Agent Executor - Intelligence gathering with web search
...
class ResearchExecutor(BaseAgentExecutor):
    """
    Research Agent Executor for intelligence gathering.
...
def create_research_executor(
    ...
    **kwargs,
    ...
    """
    Create a ResearchExecutor instance.
